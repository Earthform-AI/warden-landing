...
export const highlights: ExperimentHighlight[] = [
...

  {
    ...
    threadColor: 'green',
    summary: 'T4 lysozyme is a "hinge enzyme" — mode 1 looks allosteric, but modes 2–5 concentrate at the catalytic cleft. Hinge occupation ratio (hinge_R₂₋₅ > 1.0) cleanly distinguishes enzymes from allosteric proteins. Completes the 12/12 benchmark.',
    keyResult: '100% archetype classification (12/12), 0 false barrel, 0 regressions',
    status: 'confirmed',
    tags: ['multi-mode', 'hinge', 'T4 lysozyme', 'HingeLensSynthesis'],
  },
  {
    id: 'D110',
